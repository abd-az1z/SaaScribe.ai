            ...
            <div className="space-y-8 max-w-4xl mx-auto">
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center">
                {isSignedIn ? (
                  <Button
                    asChild
                    className="max-w-md bg-gradient-to-r from-[#00f2fe] to-[#4facfe] hover:from-[#4facfe] hover:to-[#00f2fe] text-white font-bold text-lg py-6 px-8 rounded-full transform transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#00f2fe]/40"
                  >
